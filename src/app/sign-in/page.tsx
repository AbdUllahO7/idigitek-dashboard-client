...
export default function SignIn() {
  ...
  return (
    <div 
      className="relative flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-br from-slate-900 via-indigo-950 to-purple-950 p-4"
      style={{
        backgroundImage: `radial-gradient(circle at ${gradientPosition.x}% ${gradientPosition.y}%, rgba(129, 102, 255, 0.2) 0%, rgba(65, 39, 158, 0.1) 25%, rgba(20, 20, 40, 0) 50%)`
      }}
    >
      {/* Animated glowing orb */}
      <div className="pointer-events-none absolute left-1/4 top-1/4 h-64 w-64 -translate-x-1/2 -translate-y-1/2 rounded-full bg-purple-600/10 blur-3xl" />
      <div className="pointer-events-none absolute right-1/4 bottom-1/4 h-64 w-64 -translate-x-1/2 -translate-y-1/2 rounded-full bg-indigo-600/10 blur-3xl" />
      
      {/* Animated grid lines */}
      <div className="pointer-events-none absolute inset-0 opacity-[0.03]" 
        style={{
          backgroundSize: '40px 40px',
          backgroundImage: 'linear-gradient(to right, rgb(148, 130, 255, 0.3) 1px, transparent 1px), linear-gradient(to bottom, rgb(148, 130, 255, 0.3) 1px, transparent 1px)',
        }}
      />
      ...
      <div className="relative w-full max-w-5xl">
        ...
        >
          <Card className="overflow-hidden border-none bg-black/20 backdrop-blur-xl md:flex">
            {/* Image Section */}
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <motion.div variants={itemVariants} className="space-y-2">
                      ...
                      <div className="group relative">
                        <Mail className="absolute left-3 top-1/2 h-5 w-5 -translate-y-1/2 text-slate-500 transition-colors group-focus-within:text-purple-400" />
                        <Input
                          id="email"
                          type="email"
                          ...
                          className="h-12 rounded-lg border-slate-700 bg-slate-800/50 pl-10 text-white shadow-sm transition-all focus-visible:border-purple-500 focus-visible:ring-1 focus-visible:ring-purple-500"
                        />
                        <motion.div 
                    ...
                    <motion.div variants={itemVariants} className="space-y-2">
                      ...
                      <div className="group relative">
                        <KeyRound className="absolute left-3 top-1/2 h-5 w-5 -translate-y-1/2 text-slate-500 transition-colors group-focus-within:text-purple-400" />
                        <Input
                          id="password"
                          type="password"
                          placeholder="••••••••"
