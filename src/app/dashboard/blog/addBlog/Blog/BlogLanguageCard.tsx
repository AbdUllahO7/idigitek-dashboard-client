...
import { CalendarIcon, ChevronDown, ChevronUp, X, BookOpen, Clock } from "lucide-react"
...
export const BlogLanguageCard = memo(({ langCode, form, isFirstLanguage = false, onClose }: BlogLanguageCardProps) => {
  const {
    formState: { errors },
  } = useFormContext()
    ...
    >
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between">
          <CardTitle className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              <span className="text-base font-semibold">Blog Section</span>
              {isFirstLanguage && (
        ...
        <CardDescription className="text-sm text-gray-600 mt-2">
          Manage blog content for {langCode.toUpperCase()}
        ...
        <div className="space-y-6">
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-sm font-medium">
                  Blog Title {isFirstLanguage && <span className="text-red-500">*</span>}
                </FormLabel>
                <FormControl>
                  <Input
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-sm font-medium">
                  Blog Description {isFirstLanguage && <span className="text-red-500">*</span>}
                </FormLabel>
                <FormControl>
                  <Textarea
                    placeholder="Enter blog description (excerpt/summary)"
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-sm font-medium">
                  Blog Content {isFirstLanguage && <span className="text-red-500">*</span>}
                </FormLabel>
                <FormControl>
                  <Textarea
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-sm font-medium">
                  Blog Category {isFirstLanguage && <span className="text-red-500">*</span>}
                </FormLabel>
                <FormControl>
                  <Input
