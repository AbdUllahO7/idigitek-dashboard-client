...
export default function AddContact() {
  ...
  return (
    <FormShell
      title={isCreateMode ? "Create New Contact" : "Edit Contact"}
      subtitle={isCreateMode 
        ? "Create a new service with multilingual content" 
        : `Editing "${sectionItemData?.data?.name || 'Contact'}" content across multiple languages`}
