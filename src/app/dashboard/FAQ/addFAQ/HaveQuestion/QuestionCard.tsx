...
/**
 * QuestionCard - Component for a single benefit within a language
 */
    ...
    <Card className="border border-muted">
      ...
      <CardContent className="p-4 pt-0 space-y-4">
        ...
        />
         <FormField
          control={form.control}
          name={`${langCode}.${index}.buttonText`}
          render={({ field }) => (
            <FormItem>
              <FormLabel>Button Text</FormLabel>
              <FormControl>
                <Textarea placeholder="Enter Button Text" className="min-h-[80px]" {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
