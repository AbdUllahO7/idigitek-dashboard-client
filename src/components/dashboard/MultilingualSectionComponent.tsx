  ...
  return (
    <motion.div initial="hidden" animate="visible" variants={containerVariants} className="rounded-xl overflow-hidden">
      ...
      <motion.div variants={itemVariants}>
        <Card className="border-l-4 border-l-teal-500 mb-6 overflow-hidden shadow-md">
          <CardHeader className="pb-2 bg-gradient-to-r from-teal-50 to-emerald-50 dark:from-teal-900/20 dark:to-emerald-900/20">
          ...
          <CardContent className="pt-4">
            <div className="space-y-4">
              ...
              >
                <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-gradient-to-r from-teal-500 to-emerald-500 text-white shadow-sm">
                  1
                </div>
                <div className="flex items-center gap-2">
                  <span className="font-medium">
                    Add a {sectionName} section by clicking on the{" "}
                    <span className="text-teal-600 dark:text-teal-400">"Add Section"</span> button and fill all required
                    fields
                  </span>
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  <span className="font-medium">
                    Once completed, the{" "}
                    <span className="text-teal-600 dark:text-teal-400">"Add New {sectionName}"</span> button will become
                    active
                  </span>
